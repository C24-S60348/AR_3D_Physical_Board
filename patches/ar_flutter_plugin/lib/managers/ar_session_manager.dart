...
typedef ImageDetectedHandler = void Function(String imageName);
...
class ARSessionManager {
  ...
  /// Callback triggered when a registered augmented image is detected and tracked
  ImageDetectedHandler? onImageDetected;
