...
class _NotaScreenState extends State<NotaScreen> with SingleTickerProviderStateMixin {
...
class _MelakaTab extends StatelessWidget {
  ...
  static const _places = [
    _Place(
      ...
      description: 'Kubu Portugis yang dibina pada 1512 oleh Alfonso de Albuquerque. Salah satu tinggalan Eropah tertua di Asia Tenggara.',
    ),
    _Place(
      name: 'Cheng Hoon Teng Temple',
      asset: 'assets/imagesscan/chenghoontengtemple.png',
      description: 'Kuil Cina tertua di Malaysia, dibina pada 1646. Diiktiraf sebagai Warisan Budaya oleh UNESCO.',
    ),
    _Place(
      name: 'Christ Church Melaka',
      asset: 'assets/imagesscan/christchurchmelaka.png',
      description: 'Gereja Belanda yang dibina pada 1753 dan merupakan salah satu gereja Protestant tertua di Malaysia.',
    ),
    _Place(
      name: 'Jonker Street',
      asset: 'assets/imagesscan/junkerstreetmelaka.png',
      description: 'Jalan ikonik di Pekan Cina Melaka, terkenal dengan barangan antik, kraftangan, dan pelbagai hidangan tempatan.',
    ),
    _Place(
      name: 'Masjid Selat Melaka',
      asset: 'assets/imagesscan/masjidselatmelaka.png',
      description: 'Masjid unik yang dibina di atas air, kelihatan terapung di Selat Melaka ketika air pasang.',
    ),
    _Place(
      name: 'Menara Taming Sari',
      asset: 'assets/imagesscan/menaratamingsari.png',
      description: 'Menara giroskop berputar 360° yang membawa pelancong ke ketinggian 80 meter untuk menikmati pemandangan Melaka.',
    ),
    _Place(
      name: 'Muzium Kapal Selam',
      asset: 'assets/imagesscan/muziumkapalselammelaka.png',
      description: 'Muzium berasaskan kapal selam sebenar KD Oumanoff yang boleh diterokai oleh pengunjung.',
    ),
    _Place(
      name: 'Stadthuys',
      asset: 'assets/imagesscan/stadhuysmelaka.png',
      description: 'Bangunan Belanda tertua di Asia Tenggara, dibina pada 1650. Kini berfungsi sebagai muzium sejarah dan etnografi.',
    ),
    _Place(
      name: 'St. Paul Hill Church',
      asset: 'assets/imagesscan/stpaulhillchurch.png',
      description: 'Gereja Portugis bersejarah di atas Bukit St. Paul, dibina pada 1521. Mempunyai batu nisan bertanda Eropah.',
    ),
    _Place(
      name: 'Beca Melaka',
      asset: 'assets/imagesscan/trishaw.png',
      description: 'Kenderaan ikonik Melaka yang dihiasi dengan bunga warna-warni. Menjadi simbol pelancongan unik bandar bersejarah ini.',
    ),
  ];
...
class _Place {
  ...
  const _Place({required this.name, required this.asset, required this.description});
}
...
class _NotaPermainanTab extends StatelessWidget {
  const _NotaPermainanTab();

  static const _notes = [
    _Nota(emoji: '📜', topic: 'Sejarah Melaka',
        points: [
    ...
    _Nota(emoji: '🗺️', topic: 'Pelancongan',
        points: [
...
class _Nota {
  ...
  const _Nota({required this.emoji, required this.topic, required this.points});
}
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: nota.points.map((point) => Padding(
